...
from VQC_project.Tom.main.div.old_predict_plots_and_metrics import show_all_evaluation_plots
...
circuit = {'RY_Circuit': RY_Circuit, 'RYXZ_Circuit': RYXZ_Circuit}
...
def run_model(dataset, config, circuit=None):
    ...
    loss_progress = model.train(input_train, output_train)
    ...
    show_all_evaluation_plots(loss_progress, pred_y_test_data, dataset, config)
